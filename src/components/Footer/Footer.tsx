...
const Footer = () => {
  return (
    <footer className="mt-auto bottom-0 z-999 flex w-full bg-white drop-shadow-1 dark:bg-boxdark dark:drop-shadow-none">
      <div className="flex flex-grow items-center justify-between px-4 py-4 shadow-2 md:px-6 2xl:px-11">
        <div>
          <span className="text-sm">Copyright © 2024,</span>
          <a
            href="https://www.instagram.com/shanti.digitalfactory/"
            target="_blank"
