    ...
    return (
        <nav className='mt-4'>
            <ul className="flex flex-wrap items-center justify-center">
                <li>
                    <button className="flex h-9 w-9 items-center justify-center rounded-l-md border
                     border-stroke hover:border-primary hover:bg-gray hover:text-primary dark:border-strokedark
                       dark:hover:bg-graydark dark:hover:border-white dark:hover:text-white"
                       onClick={() => onPageChange(currentPage - 1)}
                       >
                        <svg className="fill-current" width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <li key={page}>
                        <button
                            ...
                            className={`
                                ...
                                ${currentPage === page ? 'border-primary text-primary dark:border-white dark:text-white': 'border-stroke border-l-transparent'}
                ...
                <li>
                    <button className="flex h-9 w-9 items-center justify-center rounded-r-md border border-stroke border-l-transparent hover:border-primary
                     hover:bg-gray hover:text-primary dark:border-strokedark dark:hover:bg-graydark dark:hover:border-white dark:hover:text-white"
                        onClick={() => onPageChange(currentPage + 1)}>
                        <svg className="fill-current" width="8" height="16" viewBox="0 0 8 16" fill="none" xmlns="http://www.w3.org/2000/svg">
